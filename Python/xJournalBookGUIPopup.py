...
class xJournalBookGUIPopup(ptModifier):
    ...
    def IShowBook(self):
        ...
        if journalContents == "":
            PtDebugPrint("WARNING - EMPTY JOURNAL: JournalName.value = '{}' LocPath = '{}'".format(codecs.decode(JournalName.value, 'utf-8'), codecs.decode(LocPath.value, 'utf-8')), level=kDebugDumpLevel)
